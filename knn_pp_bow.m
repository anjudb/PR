...
%%%%%%%%%%%%%%%prob for each class%%%%%%%%%%%%%%%
temp=1;
length_class=ones(size(class1_testing_data.class1_testing_data,1),1);


no_of_test_class1 = size(class1_testing_data.class1_testing_data,1);
no_of_test_class2 = size(class2_testing_data.class2_testing_data,1);
no_of_test_class3 = size(class3_testing_data.class3_testing_data,1);
no_of_test_class4 = size(class4_testing_data.class4_testing_data,1);
no_of_test_class5 = size(class5_testing_data.class5_testing_data,1);
no_of_test_class6 = size(class6_testing_data.class6_testing_data,1);
no_of_test_class7 = size(class7_testing_data.class7_testing_data,1);
no_of_test_class8 = size(class8_testing_data.class8_testing_data,1);
...
save './ImageData/BoWKnn_Labels_g7.mat' labels
save './ImageData/BoWKnn_Probability_g7.mat' proab_all
...
save './ImageData/BoWKnn_TPScores_g7.mat' true_postive_score
save './ImageData/BoWKnn_FPScores_g7.mat' false_postive_score
