...
[prob_density_class1]=parzen_fun_hypersphere(training_class1,test_data,h);
[prob_density_class2]=parzen_fun_hypersphere(training_class2,test_data,h);
[prob_density_class3]=parzen_fun_hypersphere(training_class3,test_data,h);
[prob_density_class4]=parzen_fun_hypersphere(training_class4,test_data,h);
[prob_density_class5]=parzen_fun_hypersphere(training_class5,test_data,h);
[prob_density_class6]=parzen_fun_hypersphere(training_class6,test_data,h);
[prob_density_class7]=parzen_fun_hypersphere(training_class7,test_data,h);
[prob_density_class8]=parzen_fun_hypersphere(training_class8,test_data,h);
...
save './ImageData/PCAknn_Labels_g7.mat' labels
save './ImageData/PCAknn_Probability_g7.mat' proab_all
...
save './ImageData/PCAknn_TPScores_g7.mat' true_postive_score
save './ImageData/PCAknn_FPScores_g7.mat' false_postive_score
